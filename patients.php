...
<body>
    ...
    <?PHP
      ...
      if (!$link) {
        die("Cannot pull up all the patients' records! " . mysqli_error());
      }
      else {
        echo "Here are all the patients enrolled at this office! <br>";
      }
      ...
      print "<tr><td>Patient ID </td><td> Phone Number  </td><td> DOB </td><td> Person ID</td>";
